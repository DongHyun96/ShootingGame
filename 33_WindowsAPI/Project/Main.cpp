                     ...
                     _In_ int       nCmdShow)
{
    ...
    while (true)
    {
        if (PeekMessage(&msg, nullptr, 0, 0, PM_REMOVE)) // 실질적으로 메시지가 들어오면 메시지 해석 및 프로시저에 보냄
        {
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        SetWindowPos(hWnd, NULL, posX, posY - 50, 0, 0, SWP_NOSIZE | SWP_NOZORDER);
